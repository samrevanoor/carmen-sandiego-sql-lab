...
SELECT language FROM country c JOIN countrylanguage l ON c.code = l.countrycode
...
SELECT name FROM country c JOIN countrylanguage l ON c.code = l.countrycode
...
SELECT country.name from city JOIN country ON city.countrycode = country.code
WHERE city.name LIKE 'Ser%' AND country.continent = 'South America';
